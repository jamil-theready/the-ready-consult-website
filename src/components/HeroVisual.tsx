        ...
        <div className="w-[600px] bg-white rounded-2xl border border-gray-200 overflow-hidden"
          ...
          <div className="px-6 py-4 flex items-center gap-3 border-b border-gray-100">
            <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none">
              <rect x="6" y="12" width="36" height="24" rx="3" fill="#fff" stroke="#4285F4" strokeWidth="2" />
              <path d="M6 14l18 13 18-13" stroke="#EA4335" strokeWidth="2" strokeLinecap="round" />
              <path d="M6 14l18 13" stroke="#FBBC05" strokeWidth="2" strokeLinecap="round" />
              <path d="M42 14l-18 13" stroke="#34A853" strokeWidth="2" strokeLinecap="round" />
            </svg>
