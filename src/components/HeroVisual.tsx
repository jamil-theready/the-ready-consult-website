...
export default function HeroVisual() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-[420px] sm:h-[460px] lg:h-[700px]">
      ...
      {/* ===== 0: WEBSITE ===== */}
      <div className="absolute inset-0 flex items-center justify-center scale-[0.45] sm:scale-[0.6] lg:scale-100 origin-center" style={panelStyle(0)}>
      ...
      {/* ===== 1: CHATGPT ===== */}
      <div className="absolute inset-0 flex items-center justify-center scale-[0.5] sm:scale-[0.65] lg:scale-100 origin-center" style={panelStyle(1)}>
      ...
      {/* ===== 2: iPHONE ===== */}
      <div className="absolute inset-0 flex items-center justify-center scale-[0.55] sm:scale-[0.7] lg:scale-100 origin-center" style={panelStyle(2)}>
      ...
      {/* ===== 3: GMAIL ===== */}
      <div className="absolute inset-0 flex items-center justify-center scale-[0.55] sm:scale-[0.7] lg:scale-100 origin-center" style={panelStyle(3)}>
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6 scale-[0.4] sm:scale-[0.55] lg:scale-100 origin-center" style={panelStyle(4)}>
