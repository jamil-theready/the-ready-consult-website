          ...
          <div className="flex flex-wrap gap-10 sm:gap-16 lg:gap-24">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="https://calendly.com/thereadyconsult/30min" target="_blank" rel="noopener noreferrer" className="block text-[13px] text-gray-500 hover:text-navy transition-colors">Book a Call</a>
