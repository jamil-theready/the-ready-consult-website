...
export default function Features() {
  return (
    <section id="features" className="py-20 lg:py-32 bg-background rounded-[12px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <div
              ...
              className="group relative bg-gray-50 p-8 border border-gray-200 hover:border-teal/30 hover:bg-slab transition-all duration-300 rounded-[12px]"
            >
