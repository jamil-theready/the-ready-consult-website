    ...
    <>
      {blocks.map((b, i) => {
        switch (b.type) {
          ...
          case "statement": return <BlockStatement key={i} text={b.text} tone={b.tone} />;
          case "split": return <BlockSplit key={i} subheading={b.subheading} body={b.body} media={b.media} flip={b.flip} tone={b.tone} />;
          case "grid": return <BlockGrid key={i} items={b.items} columns={b.columns} />;
