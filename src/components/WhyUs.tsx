      ...
      <div className="relative max-w-[1280px] mx-auto px-6">
        ...
        <div className="rounded-2xl border border-white/10 overflow-hidden">
          <div className="grid grid-cols-2">
            <div className="p-5 lg:p-6 bg-white/5">
              <p className="text-[13px] font-semibold text-teal-light uppercase tracking-wider">The Ready Consult</p>
            </div>
            <div className="p-5 lg:p-6 border-l border-white/10 bg-white/[0.02]">
              <p className="text-[13px] font-semibold text-white/30 uppercase tracking-wider">Traditional Agencies</p>
            </div>
          </div>
          {rows.map((r) => (
            <div key={r.us} className="grid grid-cols-2 border-t border-white/10">
              <div className="p-5 lg:p-6 flex items-center gap-3">
                ...
                <span className="text-[15px] text-white font-medium">{r.us}</span>
              </div>
              <div className="p-5 lg:p-6 border-l border-white/10 flex items-center gap-3">
                <svg className="w-5 h-5 text-white/20 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
                <span className="text-[15px] text-white/40">{r.them}</span>
              </div>
            </div>
          ))}
        </div>
