...
export default function WhyUs() {
  return (
    <section className="bg-void py-24 lg:py-36 relative overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto px-6">
        ...
        <div className="border border-white/10 overflow-hidden">
          <div className="grid grid-cols-2">
            <div className="p-5 lg:p-6 bg-background/5">
              <p className="text-[13px] font-semibold text-teal-light uppercase tracking-wider">The Ready Consult</p>
            </div>
            <div className="p-5 lg:p-6 border-l border-white/10 bg-slab/[0.02]">
